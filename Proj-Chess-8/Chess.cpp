		...
		moveFromX(0), moveFromY(0), moveToX(0), moveToY(0), mouse_move(false)
{
	...
	board[0][6] = new Blank; //new Knight(1);
	board[0][1] = new Blank;//new Knight(1);
	board[0][5] = new Blank; //new Bishop(1);
	board[0][2] = new Blank;//Bishop(1);
	board[0][4] = new Blank; //new Queen(1);
